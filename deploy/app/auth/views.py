...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and user.verify_password(form.password.data):
            ...
            current_app.logger.info('{} login'.format(current_user.email))
...
def register():
    ...
    form.department.choices = [(str(dept.id), dept.name) for dept in Department.query.all()]
    ...
    if form.validate_on_submit():
        ...
        current_app.logger.info('{} register'.format(user.email))
